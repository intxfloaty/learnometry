...
const ComingSoonModal = ({ open, handleClose, modalType }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        {modalType === "resource" ?
          (<Typography>We are diligently striving to enhance our platform with new features that will further support and elevate your self-learning experience. We appreciate your patience and understanding as we work towards delivering this valuable functionality.
          </Typography>)
          : (<Typography>
