  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth={modalMaxWidth}>
      {(modalMessage) ?
        ...
        <Typography style={{ padding: "10px", fontSize: "16px", fontWeight: "bold" }}>
          As part of Learnometry Free plan, you will get 20 free responses. Upgrade your plan to enjoy unlimited daily responses and gain access to additional features.
        </Typography>}
      <DialogContent>
